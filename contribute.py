...
def arguments(argsval):
    ...
    parser.add_argument('-mc', '--max_commits', type=int, default=20,
    ...
    parser.add_argument('-un', '--user_name', type=str, required=False, default="christophergroeneveldt",
    ...
    parser.add_argument('-ue', '--user_email', type=str, required=False, default="adonis11300522@gmail.com",
                        ...
                        If not specified, the global config is used.""")
    parser.add_argument('-da', '--days_ago', type=int, required=False, default=7,
