...
import Islandswave from './assets/islandswave.png';
...
import Hiena from './assets/hiena.png';
...
function Islands() {
    return ( 
        <div className="Islands">   
            <div className="Islandswave"><img src={Islandswave} alt="Islandswave"/></div>  
            <div className="Islands-main">
                <Container className="Section-title">
                    <h5>THE</h5>
                    <h3>ISLANDS</h3>   
                    <p>Sed ut perspiciatis unde omnis iste natus error site <br/>voluptatem accusantium doloremque laudantium.</p> 
                </Container>
                <Container className="Section-body">
                    ...
                    <div className="odd-row">
                        ...
                        <Col md={6} sm={12}><img src={Hiena} alt="Hiena"/></Col>
                    </div>
                    <div className="even-row">
                        <Col md={6} sm={12}>
